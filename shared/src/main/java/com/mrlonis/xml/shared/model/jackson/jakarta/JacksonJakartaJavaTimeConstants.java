...
public class JacksonJakartaJavaTimeConstants {
    ...
    private static final Map<String, BaseModel<?>> JACKSON_JAKARTA_JAVA_TIME_NO_ZONE_MAP = Map.of(
            Constants.FIELD, JACKSON_JAKARTA_JAVA_TIME_NO_ZONE_ACCESS_TYPE_FIELD,
            Constants.NONE, JACKSON_JAKARTA_JAVA_TIME_NO_ZONE_ACCESS_TYPE_NONE,
            Constants.PROPERTY, JACKSON_JAKARTA_JAVA_TIME_NO_ZONE_ACCESS_TYPE_PROPERTY,
            Constants.PUBLIC_MEMBER, JACKSON_JAKARTA_JAVA_TIME_NO_ZONE_ACCESS_TYPE_PUBLIC_MEMBER);
    ...
    private static final Map<String, BaseModel<?>> JACKSON_JAKARTA_JAVA_TIME_ZONED_MAP = Map.of(
            Constants.FIELD, JACKSON_JAKARTA_JAVA_TIME_ZONED_ACCESS_TYPE_FIELD,
            Constants.NONE, JACKSON_JAKARTA_JAVA_TIME_ZONED_ACCESS_TYPE_NONE,
            Constants.PROPERTY, JACKSON_JAKARTA_JAVA_TIME_ZONED_ACCESS_TYPE_PROPERTY,
            Constants.PUBLIC_MEMBER, JACKSON_JAKARTA_JAVA_TIME_ZONED_ACCESS_TYPE_PUBLIC_MEMBER);

    public static final Map<TimeZoneIndicator, Map<String, BaseModel<?>>> JACKSON_JAKARTA_JAVA_TIME_MAP = Map.of(
